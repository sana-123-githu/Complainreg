...
if (isset($_POST['register'])) {
    ...
    $sql_complaints = "INSERT INTO `complaints`(`name`, `dob`, `address`, `phno`, `complaint_type`, `date`, `complaint_detail`, `photo`, `suspect_name`, `details`, `email`, `status`, `officerid`,`voice`) VALUES VALUES ('$name','$dob','$address','$mobile','$complaint_type','$date','$complaint_detail','$image','$suspect_name','$suspect_detail','$email','pending',0,'$voiceFilePath')";
